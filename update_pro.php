                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?php 
															//$department = "SELECT * FROM department_table INNER JOIN employee_table ON department_table.department = employee_table.department";
			...
			$(document).ready(function(){
				...
				$("#depart").change(function(){
					...
					var deptname = $(this).val();
						...
						//console.log(deptname);console.log(deptid);
					$.ajax({
						url: 'bidder_name.php',
						type: "POST",
						data: {depart:deptid, name:deptname},
						dataType: 'json',
